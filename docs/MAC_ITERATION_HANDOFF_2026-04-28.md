...
- O head atual desse branch deve ser consultado diretamente no PR #1 no momento do merge, porque a branch continuou a receber syncs pequenas de docs e handoff.
...
- Head atual do branch:
  - consultar o PR #1 no momento do merge/rebase
...
- O branch continuou depois disso a evoluir com novas syncs de docs e handoff.
...
- O branch no GitHub continua a frente do live.
...
- [LAB_TRADFI_CONTROLLED_OVERSOLDBOUNCE4H_CHECKLIST_2026-04-29.md](./LAB_TRADFI_CONTROLLED_OVERSOLDBOUNCE4H_CHECKLIST_2026-04-29.md)
